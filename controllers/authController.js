...
export const registerController = async(req,res)=>{
    try{
        ...
        // check whether the user is existing one or not
        ...
        //register user
        const hashedPassword = await hashPassword(password); //the logic to the hash password is written in authHelper.js file
        //save 
